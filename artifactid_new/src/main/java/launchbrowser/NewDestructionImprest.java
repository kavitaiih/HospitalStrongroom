...
public class NewDestructionImprest {

	public static void main(String[] args) throws InterruptedException {

		// Extent report setup
		ExtentReports extent = new ExtentReports();
		ExtentSparkReporter spark = new ExtentSparkReporter("DestructIMPREST.html");
		...
		extent.createTest("Go to https://hospital-staging.strongroom.ai/login").assignCategory("DestructIMPREST")
		...
		extent.createTest("Login successfully").assignCategory("DestructIMPREST").assignDevice("Chrome")
		...
		// Display status log on html report page
		extent.createTest("Go to dashboard").assignCategory("DestructIMPREST").assignDevice("Chrome").log(Status.INFO,
				"Go to dashboard");
...
// check the current balance of that particular medication for which you want to destro or perform destruction process.		
		...
		extent.createTest("Check the Available Balance for that medication on the stocktake ").assignCategory("DestructIMPREST ")
...
//Print the Available Balance 
		...
		extent.createTest("Print the current balance of that medication on the stocktake").assignCategory("DestructIMPREST").assignDevice("Chrome").log(Status.INFO,
				"Print the current balance of that medication on the stocktake");

		extent.createTest("Check the Available Balance for this medication ").assignCategory("DestructIMPREST ")
				.assignDevice("Chrome").log(Status.INFO, "Check the Available Balance for this medication");
...
//Perform the new Destruction process with Imprest option 	
		...
		extent.createTest("Click on the Destruction button").assignCategory("DestructIMPREST").assignDevice("Chrome")
		...
		extent.createTest("notes added").assignCategory("DestructIMPREST").assignDevice("Chrome").log(Status.INFO,
				"notes added");
		...
		extent.createTest("Select Imprest option").assignCategory("DestructIMPREST").assignDevice("Chrome")
		...
		extent.createTest("Select Medication from dropdown").assignCategory("DestructIMPREST").assignDevice("Chrome")
		...
		extent.createTest("Entered medication qty").assignCategory("DestructIMPREST").assignDevice("Chrome")
...
//Print the entered qty
		...
		extent.createTest("Print the entered qty ").assignCategory("DestructIMPREST").assignDevice("Chrome")
		...
		extent.createTest("Print Result qty after the destroy process completion  ").assignCategory("DestructIMPREST").assignDevice("Chrome")
...
//Continue the destruction process		
		...
		extent.createTest("Receive transfer button clicked").assignCategory("DestructIMPREST").assignDevice("Chrome")
				.log(Status.INFO, "Receive transfer button clicked");
		...
		extent.createTest("correct credentials added").assignCategory("DestructIMPREST").assignDevice("Chrome")
		...
		extent.createTest("complete button clicked").assignCategory("DestructIMPREST").assignDevice("Chrome")
...
// Compare the values
		...
		extent.createTest("Compare the values of new qty after destror process and the new qty on the stocktake ").assignCategory("DestructIMPREST").assignDevice("Chrome")
		...
		extent.createTest(
				...
				.assignCategory("DestructIMPREST").assignDevice("Chrome").log(Status.INFO,
						"Print Total Balance of the Selected medication after transaction , shown in the stocktake screen");
...
//Go to the destruction tab and check the entry of that particular medication
				...
				extent.createTest("Go to the destruction tan to check the entry of new destruction").assignCategory("DestructIMPREST").assignDevice("Chrome")
