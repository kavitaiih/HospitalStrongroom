...
public class TransferOutImprest {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		ExtentSparkReporter spark = new ExtentSparkReporter("TRansferOUTimprest.html");
		...
		extent.createTest("Go to https://hospital-staging.strongroom.ai/login")
				.assignCategory("Medication Transfer out Imprest").assignDevice("Chrome")
		...
		extent.createTest("Login successfully").assignCategory("Medication Transfer out Imprest").assignDevice("Chrome")
				.log(Status.INFO, "Login successfully");

		extent.createTest("Go to Drug register").assignCategory("Medication Transfer out Imprest")
...
// Print the  available balance of that Medicaiton on the Stocktake 	
		...
		medicationfilter.sendKeys("Entecavir (GH) 500 microgram tablet");
...
//Print the Available Balance 
		...
		extent.createTest("Check the Available Balance for this medication ").assignCategory("Medication Transfer out Imprest ")
...
//Transfer OUT Process with Imprest selection	
		...
		extent.createTest("Enter a location ").assignCategory("Medication Transfer out Imprest").assignDevice("Chrome")
		...
		extent.createTest("Select a location").assignCategory("Medication Transfer out Imprest").assignDevice("Chrome")
		...
		extent.createTest("Add text to notes").assignCategory("Medication Transfer out Imprest").assignDevice("Chrome")
				.log(Status.INFO, "Add text to notes");

		Thread.sleep(2000);

		WebElement bluebtn = wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("//p[normalize-space()='Imprest/Emergency Meds/Ward Stock']")));
		bluebtn.click();

		extent.createTest("Click the Imprest/Emergency Meds/Ward Stock button")
				.assignCategory("Medication Transfer out Imprest").assignDevice("Chrome")
		...
		WebElement dropdownTrigger = driver.findElement(By.xpath("//input[@placeholder='Type medication name here']"));
		dropdownTrigger.click();
		dropdownTrigger.sendKeys("Entac 500 microgram tablet");

		// Click on the specific option in the dropdown
		WebElement optionElement = driver.findElement(By.xpath("//div[@class='ingredient-item']//div[1]//div[1]"));
		optionElement.click();

		extent.createTest(" Enter a medication").assignCategory("Medication Transfer out Imprest").assignDevice("Chrome")
		...
		extent.createTest("Select a medication and qty").assignCategory("Medication Transfer out Imprest")
		...
		extent.createTest("Click the Add button").assignCategory("Medication Transfer out Imprest")
...
//Print the entered qty
				...
				extent.createTest(" Print New Added Quantity of the selected medication  ").assignCategory("Medication Transfer out Imprest")
				...
				extent.createTest("Click the Send Transfer button").assignCategory("Medication Transfer out Imprest").assignDevice("Chrome")
				...
				signinbtn.click();
				extent.createTest("Enter correct signature and click the Sign button").assignCategory("Medication Transfer out Imprest")
				...
				extent.createTest("complete process").assignCategory("Medication Transfer out Imprest").assignDevice("Chrome")
...
//Complete the pending transfer out process by changing the location	
				...
				extent.createTest("Switch to the location chosen in step 4").assignCategory("Medication Transfer out Imprest")
				...
				extent.createTest("Go to Stock -> Transfers in the top menu").assignCategory("Medication Transfer out Imprest")
				...
				extent.createTest("Open the new transfer row").assignCategory("Medication Transfer out Imprest").assignDevice("Chrome")
				...
				extent.createTest("Click the Complete Transfer Button").assignCategory("Medication Transfer out Imprest")
				...
				extent.createTest("Add extra info to notes").assignCategory("Medication Transfer out Imprest").assignDevice("Chrome")
				...
				extent.createTest("Add a note and click submit").assignCategory("Medication Transfer out Imprest").assignDevice("Chrome")
				...
				extent.createTest("complete button clicked").assignCategory("Medication Transfer out Imprest").assignDevice("Chrome")
...
//Check the new balance in the stocktake

				WebElement Stockbtn = wait
						.until(ExpectedConditions.elementToBeClickable(By.xpath("//p[normalize-space()='Stock']")));
				Stockbtn.click();

				extent.createTest("Click Stock in the top menu").assignCategory("Medication Transfer out Imprest").assignDevice("Chrome")
				...
				extent.createTest("Click Stock Take in the top menu").assignCategory("Medication Transfer out Imprest")
				...
				medicationfilter1.sendKeys(" Entac 500 microgram tablet");
...
//Print 
				...
				extent.createTest(
						...
						.assignCategory("Medication Transfer out Imprest").assignDevice("Chrome").log(Status.INFO,
								"Print Total Balance of the Selected medication after transaction , shown in the stocktake screen");
