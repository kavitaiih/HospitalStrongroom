...
//Log In Process
		...
		extent.createTest("Go to https://hospital-staging.strongroom.ai/login").assignCategory("New Delivery")
		...
		extent.createTest("Login successfully").assignCategory("New Delivery").assignDevice("Chrome").log(Status.INFO,
				"Login successfully");
		...
		extent.createTest("Go to /drug-register ").assignCategory("New Delivery").assignDevice("Chrome").log(Status.INFO,
				"Go to /drug-register");
