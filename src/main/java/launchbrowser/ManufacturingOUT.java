...
public class ManufacturingOUT {

	public static void main(String[] args)  throws InterruptedException {
		// TODO Auto-generated method stub
		
		ExtentReports extent = new ExtentReports();
		ExtentSparkReporter spark = new ExtentSparkReporter("ManufacturingOUT.html");
		...
		extent.createTest("Go to https://hospital-staging.strongroom.ai/login").assignCategory("ManufacturingOUT")
...
//Log in	
		...
		extent.createTest("Go to /drug-register").assignCategory("ManufacturingOUT").assignDevice("Chrome")
...
//Print the Available Balance
		...
		medidcationfilter.sendKeys("Imigran FDT 50 mg tablet");
...
// Print the Present available balance of that Medicaiton
				...
				extent.createTest("Check the Available Balance for this medication ")
						.assignCategory("ManufacturingOUT").assignDevice("Chrome")
...
//	Process of Manufacturing 
				...
				extent.createTest("Click on the Manufacturing button shown on the left menu of the dashboard ").assignCategory("ManufacturingOUT").assignDevice("Chrome")
				...
				extent.createTest("Enter reference number ans notes on the respected fields").assignCategory("ManufacturingOUT").assignDevice("Chrome")
				.log(Status.INFO, "Enter reference number ans notes on the respected fields");
				
				Thread.sleep(2000);
				
				WebElement DirecttionOUT = wait.until(
						ExpectedConditions.elementToBeClickable(By.xpath("//p[normalize-space()='Out']")));
				DirecttionOUT.click();	
				...
				Medication.click();	
				Medication.sendKeys("(sumatriptan) Imigran FDT 50 mg tablet");
				
				extent.createTest("Search for medication and select form dropdown").assignCategory("ManufacturingOUT").assignDevice("Chrome")
				.log(Status.INFO, "Search for medication and select form dropdown");
				
				Thread.sleep(2000);
				
				WebElement SelectMedication = wait.until(
						ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]")));
...
// Continue the manufacturing process	
				...
				Thread.sleep(2000);
				extent.createTest("Complete the process of Dispensing with signature verificaiton").assignCategory("ManufacturingOUT").assignDevice("Chrome")
...
//Verify the transaction on the drug register 
				...
				Thread.sleep(2000);
				extent.createTest("Verify that the Transaction for maunfacturing is IN or OUT").assignCategory("ManufacturingOUT").assignDevice("Chrome")
...
//Check the updated stock on the stocktake 
				...
				medidcationfilter1.sendKeys("Imigran FDT 50 mg tablet");
				...
				WebElement Imprest1 = wait.until(
						ExpectedConditions.elementToBeClickable(By.xpath("//p[normalize-space()='Display Imprest Only']")));
				Imprest1.click();
